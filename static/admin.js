...
const i18n = {
    en: {
        ...
        menu_dashboard: "Dashboard", menu_products: "Products", menu_promo: "Promo Codes", menu_test: "Test Delivery", menu_settings: "Settings", menu_store: "To Store", menu_logout: "Logout", menu_appearance: "Appearance",
    ...
    uk: {
        ...
        menu_dashboard: "Дашборд", menu_products: "Товари", menu_promo: "Промокоди", menu_test: "Тест видачі", menu_settings: "Налаштування", menu_store: "В магазин", menu_logout: "Вийти", menu_appearance: "Вигляд",
    ...
    ru: {
        ...
        menu_dashboard: "Дашборд", menu_products: "Товары", menu_promo: "Промокоды", menu_test: "Тест выдачи", menu_settings: "Настройки", menu_store: "В магазин", menu_logout: "Выйти", menu_appearance: "Внешний вид",
...
function showTab(tabName) {
    ...
    ['stats', 'products', 'promo', 'test', 'settings', 'appearance'].forEach(tab => { 
...
async function handleResponseError(res) {
    if (!res.ok) {
        ...
        try {
            ...
            // Деякі помилки Pydantic приходять масивом
